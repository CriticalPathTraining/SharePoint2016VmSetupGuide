...
$targetScriptPath = Join-Path $scriptFolder "\Script10_CreateWorkflowFarmScript.ps1"
...
Write-Host
Write-Host "Workflow farm has now been created. Now you can run the script to register the workflow farm with the local SharePoint farm"
Write-Host 
